...
var GunProvider = function GunProvider(_ref) {
  var peers = _ref.peers,
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["peers", "Gun", "sea", "keyFieldName", "storage"]);
  ...
  var _useGun = gundbReactHooks_umd.useGun(Gun, {
    peers: peers
  }),
      gun = _useGun[0];
  ...
  }, [isLoggedIn, appKeys, storage, keyFieldName, existingKeysStatus, setReadyToAuth, setExistingKeysStatus, setAppKeys]);
  ...
  var logout = React__default.useCallback(function () {
...
//# sourceMappingURL=gundb-react-auth.js.map
